...
const float CDS_CELL_TOLERANCE = 0.15;
...
const float LEFT_MOTOR_SPEED_CORRECTION = 1.05;
...
const float RIGHT_OPTO_SENSOR_STRAIGHT_BOUNDS = 3.03;
const float LEFT_OPTO_SENSOR_STRAIGHT_BOUNDS = 2.58;
const float MIDDLE_OPTO_SENSOR_STRAIGHT_BOUNDS = 3.03;
...
const float OPTO_SENSOR_TOLERANCE = 0.2;
